    ...
    class="absolute w-screen max-w-md top-0 end-0 bottom-0">
        <div class="bg-white border-l min-h-full shadow-lg border-zinc-300 p-4 relative dark:bg-zinc-900 dark:border-zinc-800">
            ...
            <div class="absolute end-4 top-4 flex h-7 items-center">
                <button @click="Livewire.dispatch('reset-folder', { folder_id: null })" type="button" class="relative rounded-md border text-zinc-500 border-zinc-300 p-1 focus:outline-none focus:ring-2 focus:ring-white dark:border-zinc-600 dark:text-zinc-500" @click="open = false">
